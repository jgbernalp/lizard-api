...
describe('Users Login', function () {
    ...
    it('should update a user', (done) => {
        request(app)
            .put('/v1/users/58ebff810012ff1c85fa1905')
    ...
    it('should delete a user', (done) => {
        request(app)
            .delete('/v1/users/58ebff810012ff1c85fa1905')
    ...
    it('should read one user', (done) => {
        request(app)
            .get('/v1/users/58ebff810012ff1c85fa1906')
            .set('Authorization', 'Bearer ADMIN_TOKEN')
            .end(function (err, res) {
                // console.log(res.toJSON());
    ...
    it('should list users using sort', (done) => {
        request(app)
            .get('/v1/users?sort=username,-name')
            .set('Authorization', 'Bearer ADMIN_TOKEN')
            .end(function (err, res) {
                // console.log(res.toJSON());
    ...
    it('should list users projecting fields and sorting', (done) => {
        request(app)
            .get('/v1/users?sort=username,-name&fields=username,_id')
            .set('Authorization', 'Bearer ADMIN_TOKEN')
            .end(function (err, res) {
                // console.log(res.toJSON());
    ...
    it('should list users projecting fields, sorting and limit', (done) => {
        request(app)
            .get('/v1/users?sort=username,-name&fields=username,_id&limit=2')
            .set('Authorization', 'Bearer ADMIN_TOKEN')
            .end(function (err, res) {
                // console.log(res.toJSON());
    ...
    it('should list users projecting fields, sorting, limit and page', (done) => {
        request(app)
            .get('/v1/users?sort=username,-name&fields=username,_id&limit=2&page=2')
            .set('Authorization', 'Bearer ADMIN_TOKEN')
            .end(function (err, res) {
                // console.log(res.toJSON());
    ...
    it('should be able to read its own user', (done) => {
        request(app)
            .get('/v1/users/58ebff810012ff1c85fa1905')
            .set('Authorization', 'Bearer USER_TOKEN')
            .end(function (err, res) {
                // console.log(res.toJSON());
